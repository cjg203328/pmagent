...
ArtPM treats [baidu/Unlimited-OCR](https://github.com/baidu/Unlimited-OCR) as an
optional external OCR service. The application does not install or load the OCR
model in the Streamlit process. OCR is an internal Agent skill: image and scanned
document attachments trigger it automatically, and unavailable service state
...
sidecar is ready. Full diagnostics can additionally inspect `GET /v1/models`.
