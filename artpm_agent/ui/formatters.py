"""Dependency-light formatting helpers used by Streamlit views.

This module is deliberately free of Streamlit and storage imports.  The
historical :mod:`artpm_agent.ui_formatters` module remains as a compatibility
entry point, while new code can depend on this smaller contract.
"""
