...
```bash
# 健康检查
  curl -u admin:your_password https://localhost/_stcore/health
...
python -m artpm_agent.runtime.telemetry_dashboard \
  --out artifacts/reports/telemetry_report.html \
  --window 500
```
...
**推荐阅读**:
- [完整实施报告](../reports/COMPLETE_IMPLEMENTATION_REPORT.md)
- [Phase 1 优化报告](../reports/PHASE1_OPTIMIZATION_REPORT.md)
- [优化策略文档](../reports/OPTIMIZATION_STRATEGY_MULTI_PERSPECTIVE.md)
