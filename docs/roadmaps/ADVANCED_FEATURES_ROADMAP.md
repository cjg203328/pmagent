...
**文档**: `docs/architecture/MULTI_TENANT_ARCHITECTURE.md` (3,500+ 行)
...
- [多租户架构设计](../architecture/MULTI_TENANT_ARCHITECTURE.md) - 完整 (3,500+ 行)
- [插件开发指南](../dev/PLUGIN_DEVELOPMENT_GUIDE.md) - 已有
- [API Gateway 文档](../operations/API_GATEWAY_DOCUMENTATION.md) - 已有
